...
export default function RootLayout({
  ...
  return (
    <div className="min-h-screen flex w-full text-[#1d1d1f] bg-[#f5f5f7] font-sans selection:bg-[#0071e3]/20 selection:text-[#0071e3]">
        ...
        <div className="p-6 border-t border-[#e5e5ea] bg-white/20">
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-[#f5f5f7] border border-[#e5e5ea]">
            ...
            <div className="text-xs">
              ...
              <p className="text-[10px] text-[#86868b]">Custom Trained AI Core</p>
            </div>
          </div>
        </div>
      </aside>
